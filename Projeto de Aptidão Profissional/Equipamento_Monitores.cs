...
{
    public partial class Equipamento_Monitores : UserControl
    {
        public Equipamento_Monitores()
        {
            InitializeComponent();
        }
        ...
        //Metodo Load
        private void Equipamento_Monitores_Load(object sender, EventArgs e)
        {
        ...
        private void Equipmonitor1_Click(object sender, EventArgs e)
        {
            FLayout PD = (FLayout)this.Parent;
            ...
            query = "Select quantidade from stock where CodProduto = 'equipmonitor1'";
            ...
            if (quantidade > 0)
            {
                query = "Select CodProduto from Carrinho where CodProduto = 'equipmonitor1' and Username = '" + PD.Username + "'";
                ...
                if (contar == 1)
                {
                    ...
                    query = "select quantidade from carrinho where CodProduto = 'equipmonitor1' and Username = '" + PD.Username + "'";
                    ...
                    query = "Update Carrinho set Quantidade = " + quantidadeLocal + " where CodProduto = 'equipmonitor1' and Username = '" + PD.Username + "'";
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        "values('" + codregisto + "', 'equipmonitor1','ASUS - VS197DE', 1, 76.33, '" + PD.Username + "')";
        ...
        private void Equipmonitor2_Click(object sender, EventArgs e)
        {
            FLayout PD = (FLayout)this.Parent;
            ...
            query = "Select quantidade from stock where CodProduto = 'equipmonitor2'";
            ...
            if (quantidade > 0)
            {
                query = "Select CodProduto from Carrinho where CodProduto = 'equipmonitor2' and Username = '" + PD.Username + "'";
                ...
                if (contar == 1)
                {
                    ...
                    query = "select quantidade from carrinho where CodProduto = 'equipmonitor2' and Username = '" + PD.Username + "'";
                    ...
                    query = "Update Carrinho set Quantidade = " + quantidadeLocal + " where CodProduto = 'equipmonitor2' and Username = '" + PD.Username + "'";
                ...
                else
                {
                    ...
                    {
                        query = "insert into Carrinho(CodRegisto, CodProduto, NomeProduto, Quantidade, Preco, Username)" +
                        "values('" + codregisto + "', 'equipmonitor2','ASUS - VP228DE', 1, 93.14, '" + PD.Username + "')";
        ...
        private void Equipmonitor3_Click(object sender, EventArgs e)
        {
            FLayout PD = (FLayout)this.Parent;
            ...
            query = "Select quantidade from stock where CodProduto = 'equipmonitor3'";
            ...
            if (quantidade > 0)
            {
                query = "Select CodProduto from Carrinho where CodProduto = 'equipmonitor3' and Username = '" + PD.Username + "'";
                ...
                if (contar == 1)
                {
                    ...
                    query = "select quantidade from carrinho where CodProduto = 'equipmonitor3' and Username = '" + PD.Username + "'";
                    ...
                    query = "Update Carrinho set Quantidade = " + quantidadeLocal + " where CodProduto = 'equipmonitor3' and Username = '" + PD.Username + "'";
                ...
                else
                {
                    ...
                    {
                        query = "insert into Carrinho(CodRegisto, CodProduto, NomeProduto, Quantidade, Preco, Username)" +
                        "values('" + codregisto + "', 'equipmonitor3','ASUS - VP228HE', 1, 102.53, '" + PD.Username + "')";
        ...
        private void Equipmonitor4_Click(object sender, EventArgs e)
        {
            FLayout PD = (FLayout)this.Parent;
            ...
            query = "Select quantidade from stock where CodProduto = 'equipmonitor4'";
            ...
            if (quantidade > 0)
            {
                query = "Select CodProduto from Carrinho where CodProduto = 'equipmonitor4' and Username = '" + PD.Username + "'";
                ...
                if (contar == 1)
                {
                    ...
                    query = "select quantidade from carrinho where CodProduto = 'equipmonitor4' and Username = '" + PD.Username + "'";
                    ...
                    query = "Update Carrinho set Quantidade = " + quantidadeLocal + " where CodProduto = 'equipmonitor4' and Username = '" + PD.Username + "'";
                ...
                else
                {
                    ...
                    {
                        query = "insert into Carrinho(CodRegisto, CodProduto, NomeProduto, Quantidade, Preco, Username)" +
                        "values('" + codregisto + "', 'equipmonitor4','ASUS - VE248HR', 1, 144.86, '" + PD.Username + "')";
        ...
        private void Equipmonitor5_Click(object sender, EventArgs e)
        {
            FLayout PD = (FLayout)this.Parent;
            ...
            query = "Select quantidade from stock where CodProduto = 'equipmonitor5'";
            ...
            if (quantidade > 0)
            {
                query = "Select CodProduto from Carrinho where CodProduto = 'equipmonitor5' and Username = '" + PD.Username + "'";
                ...
                if (contar == 1)
                {
                    ...
                    query = "select quantidade from carrinho where CodProduto = 'equipmonitor5' and Username = '" + PD.Username + "'";
                    ...
                    query = "Update Carrinho set Quantidade = " + quantidadeLocal + " where CodProduto = 'equipmonitor5' and Username = '" + PD.Username + "'";
                ...
                else
                {
                    ...
                    {
                        query = "insert into Carrinho(CodRegisto, CodProduto, NomeProduto, Quantidade, Preco, Username)" +
                        "values('" + codregisto + "', 'equipmonitor5','ASUS - VG248QE', 1, 252.95, '" + PD.Username + "')";
        ...
        private void Equipmonitor6_Click(object sender, EventArgs e)
        {
            FLayout PD = (FLayout)this.Parent;
            ...
            query = "Select quantidade from stock where CodProduto = 'equipmonitor6'";
            ...
            if (quantidade > 0)
            {
                query = "Select CodProduto from Carrinho where CodProduto = 'equipmonitor6' and Username = '" + PD.Username + "'";
                ...
                if (contar == 1)
                {
                    ...
                    query = "select quantidade from carrinho where CodProduto = 'equipmonitor6' and Username = '" + PD.Username + "'";
                    ...
                    query = "Update Carrinho set Quantidade = " + quantidadeLocal + " where CodProduto = 'equipmonitor6' and Username = '" + PD.Username + "'";
                ...
                else
                {
                    ...
                    {
                        query = "insert into Carrinho(CodRegisto, CodProduto, NomeProduto, Quantidade, Preco, Username)" +
                        "values('" + codregisto + "', 'equipmonitor6','ASUS - MX28AQ', 1, 380.43, '" + PD.Username + "')";
        ...
        private void Equipmonitor7_Click(object sender, EventArgs e)
        {
            FLayout PD = (FLayout)this.Parent;
            ...
            query = "Select quantidade from stock where CodProduto = 'equipmonitor7'";
            ...
            if (quantidade > 0)
            {
                query = "Select CodProduto from Carrinho where CodProduto = 'equipmonitor7' and Username = '" + PD.Username + "'";
                ...
                if (contar == 1)
                {
                    ...
                    query = "select quantidade from carrinho where CodProduto = 'equipmonitor7' and Username = '" + PD.Username + "'";
                    ...
                    query = "Update Carrinho set Quantidade = " + quantidadeLocal + " where CodProduto = 'equipmonitor7' and Username = '" + PD.Username + "'";
                ...
                else
                {
                    ...
                    {
                        query = "insert into Carrinho(CodRegisto, CodProduto, NomeProduto, Quantidade, Preco, Username)" +
                        "values('" + codregisto + "', 'equipmonitor7','ASUS - MONITOR ROG STRIX CURVO 27P', 1, 427.65, '" + PD.Username + "')";
